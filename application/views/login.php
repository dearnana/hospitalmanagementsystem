...
<html>
	...
	<body>
        ...
        <style>
      body {
        /* background-image: url("template/images/banner-bgggg.jpg");
        background-size: cover; */
        background-image: url('template/images/banner-bgggg.jpg'), url('template/images/banner-bg.jpg'), url('template/images/banner-bgg.jpg');
        background-size: cover;
      ...
      @keyframes slide {
        ...
        33% {
          background-image: url('template/images/banner-bg.jpg'), url('template/images/banner-bgg.jpg'), url('template/images/banner-bgggg.jpg');
        }
        66% {
          background-image: url('template/images/banner-bgg.jpg'), url('template/images/banner-bgggg.jpg'), url('template/images/banner-bg.jpg');
        }
        100% {
          background-image: url('template/images/banner-bgggg.jpg'), url('template/images/banner-bg.jpg'), url('template/images/banner-bgg.jpg');
        }
            ...
            <div class="span4 offset4">
                <div class="padded">
                    <center>
                         <img src="<?php echo base_url();?>uploads/hmslg.png" style="height:80px;" /> 
                        <h4>Hospital Management System</h4>
                    </center>
                    <div class="login box" style="margin-top: 10px;">
                        <div class="box-header">
                            <span class="title"><?php echo ('Login To Account');?></span>
                        </div>
